...
```{r}
k <- 3
# Utiliser les données Iris direct et pas le carré des distances euclidiennes
kmeans_result <- kmeans(euclidean_distance_matrix, centers = k)
print(kmeans_result)
# afficher l'intertie intra classe
...
plot(partition_simple, main = "Lien simple avec cutree")
```
# (b) Lien moyen
```{r}
...
plot(partition_mean, main = paste("Mean (Cut Height =", cut_height_mean, ")"))
```
# (c) Lien complet
```{r}
