...
compute_sil <- function(matrix, partition) {
...
cah_simple$cluster
var <- as.cluster(cah_simple)
var
silhouette_index_simple <- compute_sil(euclidean_distance_matrix, var)
cat("Silhouette Index for Single Linkage:", silhouette_index_simple, "\n")
silhouette_index_simple
```
## (b) Lien moyen
```{r}
```` 
